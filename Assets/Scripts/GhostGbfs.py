...
direction[0] = int(args[3])
direction[1] = int(args[4])
direction[2] = int(args[5])
direction[3] = int(args[6])
...
for i in range(len(availableDirections)):
    ...
    newPath[0] = ghost[0] + availableDirections[i][0]
    newPath[1] = ghost[1] + availableDirections[i][1]
